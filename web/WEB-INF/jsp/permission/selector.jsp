...
<div class="modal-dialog modal-lg" role="document">
	...
	<script>
        	// 构造DataTable
			var table = $('#tableSysPermissionSelector').DataTable ({
        	...
        	table.on( 'draw', function () {
        		$('#tableSysPermissionSelector tbody tr').each (function () {
            ...
            $('#tableSysPermissionSelector tbody').on( 'click', 'tr', function () {
			...
			// 增加确定和取消按钮
			$('#tableSysPermissionSelector_length').append(" <a class='btn btn-primary btn-sm'>确定</a>" 
				+ " <a class='btn btn-primary btn-warning btn-sm'>取消</a>");
			// 确定按钮点击事件
			$('#tableSysPermissionSelector_length a:first').click (function () {
				// 保存选中数据
				idField.val(selectedData.id.join(','));
				nameField.val(selectedData.name.join(','));
				// 隐藏对话框
				$('#tableSysPermissionSelector').parents ('.modal').modal('hide');
			});
			// 取消按钮点击事件
			$('#tableSysPermissionSelector_length a:last').click (function () {
				// 隐藏对话框
				$('#tableSysPermissionSelector').parents ('.modal').modal('hide');
			});
		</script>
