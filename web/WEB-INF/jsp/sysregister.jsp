...
<link href="sb-admin2/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
	type="text/css">
<link
							...
							<form class="user">
								<div class="form-group">
									<input type="text" class="form-control form-control-user"
										id="loginName" placeholder="loginName" name="loginName">
								</div>
								...
								<a href="index.html" class="btn btn-google btn-user btn-block">
									Already have an account?Login! </a> <a href="index.html"
									class="btn btn-facebook btn-user btn-block"> Forgot
									Password? </a>
							</form>
							<hr>
						</div>
